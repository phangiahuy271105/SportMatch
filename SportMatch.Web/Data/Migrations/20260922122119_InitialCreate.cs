        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrustScore = table.Column<decimal>(type: "decimal(3,1)", precision: 3, scale: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VenueComplexId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SportName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CourtType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    OffPeakPrice = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false),
                    PeakPrice = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportCourts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SportCourts_VenueComplexes_VenueComplexId",
                        column: x => x.VenueComplexId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SportCourtId = table.Column<int>(type: "int", nullable: false),
                    ...
                    OpenForMatchmaking = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_SportCourts_SportCourtId",
                        column: x => x.SportCourtId,
                        principalTable: "SportCourts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourtTimeSlots_SportCourts_SportCourtId",
                        column: x => x.SportCourtId,
                        principalTable: "SportCourts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_SportCourtId",
                table: "Bookings",
                column: "SportCourtId");

            migrationBuilder.CreateIndex(
                name: "IX_CourtTimeSlots_SportCourtId",
                table: "CourtTimeSlots",
                column: "SportCourtId");

            migrationBuilder.CreateIndex(
                name: "IX_SportCourts_VenueComplexId",
                table: "SportCourts",
                column: "VenueComplexId");
        }
